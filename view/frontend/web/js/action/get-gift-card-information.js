    ...
    return {
        ...
        check: function (giftCardCode) {
            ...
            if (!customer.isLoggedIn()) {
                serviceUrl = urlBuilder.createUrl('/carts/guest-carts/:cartId/checkGivexGiftCard/:giftCardCode', {
                    cartId: quote.getQuoteId(),
                    giftCardCode: giftCardCode
                });
            } else {
                serviceUrl = urlBuilder.createUrl('/carts/mine/checkGivexGiftCard/:giftCardCode', {
                    giftCardCode: giftCardCode
                });
